...
def load_onto():
    try:
        ...
        req.args= ['/root/ros_ws/src/erl2/cluedo_ontology.owl', 'http://www.emarolab.it/cluedo-ontology', 'true', 'PELLET', 'true']
...
def save():
	try:
		...
		req.args= ["/root/ros_ws/src/erl2/cluedo_ontology.owl"]
		msg = armor_service(req)
		res=msg.armor_response
	except rospy.ServiceException as e:
		print(e)
